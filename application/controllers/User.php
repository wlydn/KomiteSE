...
class User extends MY_Controller {
	...
	public function dashboardDetail($id){
		...
		$data['onePelanggaranAll'] = $this->user_model->getOnePelanggaranByID($this->encrypt->decode($id));
		$data['oneSiswa'] = $this->user_model->getOneSiswa($this->encrypt->decode($id));
		$data['pelanggaranTotal'] = $this->user_model->getCountPelanggaran($this->encrypt->decode($id));
		$data['pelanggaran'] = $this->user_model->getPelanggaranByID($this->encrypt->decode($id));

		// Title sudah di-set otomatis di MY_Controller
		$data['page'] = "Detail Pelanggaran";
		$this->load_template('user/layout/user_template','user/user_dashboardDetail',$data);
	...
	public function listPenilaian(){
		...
		$data['tipePenilaian'] = $this->user_model->getKategoriPenilaian();
	...
	public function listPenilaianEdit($id = null){
		...
		$data['onepel'] = $this->user_model->getOnePelanggaran($this->encrypt->decode($id));
		...
		$data['pelanggaranAll'] = $this->user_model->getKategoriPelanggaran();
		$data['userAll'] = $this->user_model->getUser();
