              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Admin/listPenilaian');?>"><small><?= htmlspecialchars($parent, ENT_QUOTES, 'UTF-8') ;?></small></a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('Admin/listPenilaianAdd/');?>"><small><?= htmlspecialchars($page, ENT_QUOTES, 'UTF-8') ;?></small></a></li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
            ...
            <div class="container-fluid col-sm-8">
              ...
              <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('Admin/dataListPenilaianAdd')?>" method="post">
                    ...
                    <div class="form-group text-right">
                      <a class="btn btn-danger btn-sm" href="<?= base_url('Admin/dataListPenilaianAdd');?>"><i class="fa fa-undo"></i>&ensp;Reset</a>
