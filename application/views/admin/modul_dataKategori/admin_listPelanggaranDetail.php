              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Admin/dataKategoriListPelanggaranDetail/'.$this->encrypt->encode('id'));?>"><small><?= $page ;?></small></a></li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
                ...
                <div class="card-body">
                  ...
                  <form action="<?= base_url('Admin/dataKategoriListPelanggaranAdd')?>" method="post">
                    ...
                    <div class="form-group text-right">
                      <a class="btn btn-warning btn-sm" href="<?= base_url('Admin/dataKategoriListPelanggaranEdit/'.$this->encrypt->encode($onepel->id_pelanggaran));?>"><i class="fas fa-edit"></i>&ensp;Edit</a>
                    </div> 
