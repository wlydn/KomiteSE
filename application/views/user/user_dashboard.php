          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('user/dAdministrator')?>"><small><?= $page ;?></small></a></li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
                  ...
                  <table id="terbanyak" class="table table-bordered table-striped display nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="width: 10px; text-align: center"><?= $terbanyak->total_penilaian ;?></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
                ...
                <table id="terakhir" class="table table-bordered table-striped display nowrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $terakhir->total_penilaian ;?> Penilaian</td>
