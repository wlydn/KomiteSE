      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('Guru/pengaturanUserEdit')?>"><small><?= $page ;?></small></a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h4 class="card-title " text-align="center"><strong>Ubah Password</strong></h4>
                  <a class="btn btn-secondary btn-sm float-right" href="<?php echo base_url('Guru');?>">
                    <i class="fas fa-arrow-left"></i>&ensp;Back
                  </a>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?= base_url('Guru/updatePassword');?>" method="post">
              <div class="card-body">
