  ...
  <p style="text-align:center"><img alt="" src="<?= base_url('assets/sips/');?>img/logo1.png" style="float:left; height:100px; width:100px " />
    <span style="font-size:20px"><span style="font-family:Times New Roman,Times,serif">PEMERINTAH KABUPATEN WONOSOBO
      ...
      <div style="padding-left: 15px; padding-right: 20px;">
        ...
        <p style="text-align:center"><span style="font-size:18px"><span style="font-family:Times New Roman,Times,serif"><strong>SURAT PERNYATAAN</strong></span></span></p>

        <p>&nbsp;</p>

        <p><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Yang bertanda tangan dibawah ini:</span></span></p>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
          <tbody>
            <tr>
              ...
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->nisn;?></span></span></td>
            </tr>
            <tr>
              ...
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->std_name;?></span></span></td>
            </tr>
            <tr>
              <td style="width:170px"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Kelas</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->class_name;?></span></span></td>
            </tr>
            <tr>
              ...
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $oneSis->parent_name;?></span></span></td>
            </tr>
            <tr>
              <td style="width:170px"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Alamat</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->address;?></span></span></td>
            </tr>
            <tr>
              ...
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $oneSis->phone_number_wali;?></span></span></td>
            </tr>
          </tbody>
        </table>
        ...
        <ol>
          ...
          <li style="text-align:justify"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Saya berjanji untuk menghormati dan menunjung tinggi peraturan dan tata tertib yang berlaku di <?= $oneWeb->school_name ;?> dan tidak akan mengulangi kesalahan berupa <strong><?= $onepel->violation_name ?></strong> demi untuk menjaga kehormatan, nama baik sekolah dan untuk kepentingan diri sendiri sebagai siswa, dimana saya menuntut ilmu</span></span></li>
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
            <tbody>
              <tr>
                ...
                <tr>
                  <td style="text-align:center"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $oneSis->parent_name?></span></span></td>
                  <td>&nbsp;</td>
                  <td style="text-align:center"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->std_name?></span></span></td>
                </tr>
              </tbody>
            </table>
