          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('Guru/listPelanggaran')?>"><small><?= $page ;?></small></a></li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        ...
        <div class="container-fluid">
          ...
          <div class="card card-outline card-info">
            <div class="card-header">
              ...
              <a class="btn btn-sm btn-outline-info float-right" href="<?= base_url('Guru/listPenilaianAdd')?>">
