              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Guru/listPenilaian');?>"><small><?= $parent ;?></small></a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('Guru/listPenilaianEdit/'.$this->encrypt->encode($onepel->id_penilaian));?>"><small><?= $page ;?></small></a></li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
            ...
            <div class="container-fluid col-sm-8">
              ...
              <div class="card card-outline card-info">
                <div class="card-header">
                  ...
                  <a class="btn btn-secondary btn-sm float-right" href="<?php echo base_url('Guru/listPenilaian');?>">
                    <i class="fas fa-arrow-left"></i>&ensp;Back
                  </a>
                </div>
                <div class="card-body">

                  <form action="<?= base_url('Guru/listPenilaianEdit/'.$this->encrypt->encode($onepel->id_penilaian).'')?>" method="post">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <select id="karyawan" name="karyawan" class="form-control select2" style="width: 100%;">
                            ...
                            <?php foreach($guruAll as $karyawan): ?>
